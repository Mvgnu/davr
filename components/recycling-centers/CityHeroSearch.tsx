...
const CityHeroSearch: React.FC<CityHeroSearchProps> = ({
  cityName,
  stats,
  initialCity = '',
  initialMaterial = '',
    ...
    <div className="rounded-3xl shadow-2xl mb-4 overflow-hidden relative bg-gradient-to-br from-green-800 to-green-700">
      ...
      <div className="relative z-10 p-6 md:p-10">
        <div className="max-w-5xl mx-auto">
          {/* Custom City Hero content */}
          <div className="mb-8 text-center md:text-left">
            <h1 className="text-3xl md:text-5xl font-bold mb-4 text-white leading-tight">
              Recyclingcenter in <span className="text-emerald-300">{cityName}</span> finden
            </h1>
            <div className="flex flex-col md:flex-row gap-4 justify-center md:justify-start">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl px-4 py-3 inline-flex items-center">
                ...
                <div>
                  <div className="text-xs text-emerald-200">Stadt</div>
                  <div className="text-xl font-bold text-white">{cityName}</div>
                </div>
              </div>
            </div>
          </div>
